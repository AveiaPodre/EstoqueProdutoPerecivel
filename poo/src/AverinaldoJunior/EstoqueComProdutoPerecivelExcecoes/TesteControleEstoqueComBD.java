...
public class TesteControleEstoqueComBD {
	
	@Test
	public void testarCadastroProduto() throws ProdutoJaCadastrado, DadosInvalidos, ProdutoInexistente, SQLException, ClassNotFoundException {
	...
	public void testarCadastroProdutosInvalidos() throws ProdutoJaCadastrado, DadosInvalidos, ProdutoInexistente {
	  ...
	  } catch (DadosInvalidos | SQLException | ClassNotFoundException e) {
		// Pegou dado inválido
 	  }
	  
	  p1 = new Produto(1, null, 5, 0.20, f1);
	  try {
		est.incluir(p1);
		fail("Descr inválido");
	  } catch (DadosInvalidos | SQLException | ClassNotFoundException e) {
	  ...
	  p1 = new Produto(1, "Omo", -5, 0.20, f1);
	  try {
		est.incluir(p1);
		fail("Min inválido");
	  } catch (DadosInvalidos | SQLException | ClassNotFoundException e) {
	  ...
	  try {
		...
		est.incluir(p1);
		fail("Duplicado");
	  } catch (DadosInvalidos | SQLException | ClassNotFoundException | ProdutoJaCadastrado e) {
		// Pegou produto cadastrado
	  }
	}
	
	@Test
	public void testarVenda() throws ProdutoJaCadastrado, DadosInvalidos, ProdutoInexistente, ProdutoNaoPerecivel, ProdutoVencido, SQLException, ClassNotFoundException {
	  Fornecedor f1 = new Fornecedor(1, "Forn1");
	...
	@Test
	public void testarVendaInvalida() throws ProdutoJaCadastrado, DadosInvalidos, ProdutoNaoPerecivel, ProdutoInexistente, ProdutoVencido, SQLException, ClassNotFoundException {
	  Fornecedor f1 = new Fornecedor(1, "Forn1");
	  Produto p1 = new Produto(1, "coca-cola", 5, 0.5, f1);
	  ...
	  try {
		est.comprar(1, -10, 2.0, null);
		fail("Quant compra invalida");
	  } catch (DadosInvalidos e) {
	  } 
	  
	  try {
		est.comprar(1, 10, -2.0, null);
		fail("Preço compra invalida");
	  } catch (DadosInvalidos e) {
	  }
	  ...
	  try {
		val = est.vender(1, 500);
		fail("Quantidade maior");
	  } catch (DadosInvalidos e) {
	  } 
	}
	
	@Test
	public void testarAtualizacaoPrecoDeCompra() throws ProdutoJaCadastrado, DadosInvalidos, ProdutoInexistente, ProdutoNaoPerecivel, SQLException, ClassNotFoundException {
	  Fornecedor f1 = new Fornecedor(1, "Forn1");
	  Produto p1 = new Produto(1, "coca-cola", 5, 0.5, f1);
	...
	@Test
	public void testarCompraProdutosPereciveis() throws ProdutoJaCadastrado, DadosInvalidos, ProdutoInexistente, ProdutoNaoPerecivel, SQLException, ClassNotFoundException {
	  Fornecedor f1 = new Fornecedor(1, "Forn1");
	  Produto p1 = new Produto(1, "coca-cola", 5, 0.5, f1);
	...
	@SuppressWarnings("deprecation")
	@Test
	public void testarVendaProdutosPereciveis() throws ProdutoJaCadastrado, ProdutoInexistente, ProdutoNaoPerecivel, ProdutoVencido, DadosInvalidos, SQLException, ClassNotFoundException {
	  Fornecedor f1 = new Fornecedor(1, "Forn1");
	  Produto p2 = new ProdutoPerecivel(2, "Arroz Maria", 10, 0.2, f1);
	...
	@SuppressWarnings("deprecation")
	@Test
	public void testarVendaProdutosPereciveisVencidos() throws ProdutoJaCadastrado, DadosInvalidos, ProdutoInexistente, ProdutoNaoPerecivel, ProdutoVencido, SQLException, ClassNotFoundException {
	  Fornecedor f1 = new Fornecedor(1, "Forn1");
	  Produto p2 = new ProdutoPerecivel(2, "Arroz Maria", 10, 0.2, f1);
	...
	@SuppressWarnings("deprecation")
	@Test
	public void testarVendaProdutosPereciveisInvalidos() throws ProdutoJaCadastrado, ProdutoVencido, ProdutoInexistente, DadosInvalidos, ProdutoNaoPerecivel, SQLException, ClassNotFoundException {
	  Fornecedor f1 = new Fornecedor(1, "Forn1");
	  Produto p2 = new ProdutoPerecivel(2, "Arroz Maria", 10, 0.2, f1);
	  Produto p1 = new Produto(1, "coca-cola", 5, 0.5, f1);
	...
	@Test
	public void testarEstoqueMinimo() throws ProdutoJaCadastrado, DadosInvalidos, ProdutoInexistente, ProdutoNaoPerecivel, SQLException, ClassNotFoundException {
	  Fornecedor f1 = new Fornecedor(1, "Forn1");
